...
export const agentTasks = mysqlTable("agentTasks", {
  ...
  dueDate: timestamp("dueDate"),
  category: mysqlEnum("category", ["immediate", "short_term", "deferred", "01_content_creation", "02_platform_presence", "03_email_dm_outreach"]).default("short_term").notNull(),
  ...
  errorMessage: text("errorMessage"),
  metadata: json("metadata"),
  contextStack: json("contextStack"),
